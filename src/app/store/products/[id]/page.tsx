...
export default function StoreProductDetailPage({
  ...
  if (!product) {
    return (
      <div className="text-center py-20 text-zinc-400">Product not found</div>
    );
  }
  ...
  function handleAddToCart() {
    ...
    if (!moqMet) {
      toast.error(`Minimum order is ${product!.moq} units`);
      return;
    }
    addItem({
      ...
      factoryName: factory?.companyName ?? "Unknown Factory",
      quantity,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          {product.images.length > 0 ? (
            <div>
              <div className="relative aspect-square rounded-xl overflow-hidden bg-zinc-50 border border-zinc-100">
                <Image
                  ...
                  alt={product.images[mainImage]?.altText ?? product.name}
                  fill
            ...
            <div className="aspect-square rounded-xl bg-zinc-100 flex items-center justify-center text-zinc-300">
              No image
            </div>
          )}
            ...
            <CardContent className="p-5 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                {[
                  ...
                  {
                    label: "Sample",
                    value: product.sampleAvailable
                      ? `Yes — ${formatCurrency(product.samplePrice ?? 0)}`
                      : "Not available",
                  },
                ].map((pair) => (
                  <div key={pair.label}>
            ...
            <Card>
              <CardContent className="p-5">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  ...
                  {factory.yearsInBusiness} yrs · {factory.employeeCount}{" "}
                  employees
                </p>
        ...
        <div>
          <div className="sticky top-20 space-y-4">
                  ...
                  {sortedTiers.map((tier, i) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={
                            isActive ? "text-indigo-700 font-medium" : "text-zinc-600"
                          }
                        >
                          {tier.minQty}
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={`font-semibold ${
                              isActive ? "text-indigo-700" : "text-emerald-700"
                            }`}
                          >
                    ...
                    <button
                      ...
                      className={`h-10 min-w-10 px-3 rounded-lg border text-sm font-medium transition-colors ${
                        selectedSize === size
                          ...
                          : "border-zinc-200 text-zinc-700 hover:border-indigo-300"
                      }`}
                    >
                      {size}
                    </button>
            ...
            <Button
              ...
              disabled={!moqMet || !selectedVariant}
