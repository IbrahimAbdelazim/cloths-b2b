    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
            ...
            <CardContent className="space-y-3">
              ...
              {status === "PENDING_APPROVAL" && (
                <div className="space-y-2 pt-2 border-t border-zinc-100">
                  ...
                  {!showRejectForm ? (
                    <Button variant="outline" className="w-full text-rose-600 border-rose-200 hover:bg-rose-50" onClick={() => setShowRejectForm(true)}>
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <div className="flex gap-2">
                        <Button variant="destructive" className="flex-1 text-xs h-8" onClick={handleReject}>Confirm</Button>
                        <Button variant="outline" className="flex-1 text-xs h-8" onClick={() => setShowRejectForm(false)}>Cancel</Button>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {status === "APPROVED" && (
                <div className="pt-2 border-t border-zinc-100 text-sm text-emerald-600 flex items-center gap-2">
                  <ShieldCheck className="h-4 w-4" />Product is live
                </div>
              )}
              {status === "REJECTED" && (
          ...
          {factory && (
            <Card>
              <CardHeader><CardTitle className="text-sm">Factory</CardTitle></CardHeader>
              <CardContent className="space-y-2">
                ...
                <Link href={`/admin/factories/${factory.id}`} className="text-xs text-violet-600 hover:underline">
